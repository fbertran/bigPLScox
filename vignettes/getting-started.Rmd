...
# Scaling up with big-memory matrices

When the dataset exceeds RAM capacity, convert it to a
`bigmemory::big.matrix`. The fast backend natively operates on the resulting
pointer without copying the data.

```{r big-memory, cache=TRUE, eval=LOCAL}
